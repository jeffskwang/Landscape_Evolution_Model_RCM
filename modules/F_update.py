...
def f_update(eta_old,eta_temp,eta_new,eta_average, area, discharge,incision,lateral_incision,diffusion,t):
	...
	for x in xrange(0,cellsx+2):
		for y in xrange(0,cellsy+2):
			...
			diffusion[x][y] = 0.0
	return eta_old,eta_temp,eta_new,eta_average, area, discharge,incision,lateral_incision,diffusion
